...
function install_boost {
    local boost_ver=1_72_0
    local boost_ver_dot=1.72.0
    
    if [[ ! -f "${home_dir}/source/boost_${boost_ver}.tar.gz" ]]; then
        curl -o boost_${boost_ver}.tar.gz -SL https://dl.bintray.com/boostorg/release/${boost_ver_dot}/source/boost_${boost_ver}.tar.gz
